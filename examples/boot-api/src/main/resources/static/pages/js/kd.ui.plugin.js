	...
	kd: {
		...
		kdPager: {
			...
			init: function(config) {
				...
				this.totalPage = (this.totalPage < 1) ? 0 : this.totalPage;
		...
		kdWin: function (width, height, title, contentInfo, backcallok, type, contentType, hidebg, undrag, backcallcancel, okTxt, cancelTxt, onload) {
			...
			winHTML.push("<div id='kd-ui-dialog-title'><h2>", title, "</h2><span id='kd-ui-dialog-close' style='display:block;' ></span></div>");
			...
			var moveX = 0, moveY = 0, moveable = false, moveLeft = 0, moveTop = !$.support.leadingWhitespace == 6 ? est: 0;
