...
public class ForwardActivity {
	...
	public String index1(HttpSession session,ModelMap map,@RequestParam(required = false) String data, ModelMap model,
						@PageableDefault(value = 10)Pageable pageable) {
		map.put("title", "你好");
		getXbStudentList1(data,model,pageable);
	...
	public void getXbStudentList1(@RequestParam(required = false) String data, ModelMap model, Pageable pageable){
		Map<String,Object> resultMap = new HashMap<>();
		Map<String,Object> searhMap = new HashMap<>();
